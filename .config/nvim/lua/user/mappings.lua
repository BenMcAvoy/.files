...
local function float_term() require("nvterm.terminal").toggle("float") end
local function vertical_term() require("nvterm.terminal").toggle("vertical") end
local function horizontal_term() require("nvterm.terminal").toggle("horizontal") end

vim.keymap.set('n', '<Leader>tt', float_term)
vim.keymap.set('n', '<Leader>tv', vertical_term)
vim.keymap.set('n', '<Leader>th', horizontal_term)
